...
var Catalog, Chain, EventEmitter, MATCH_HEADERS, MODES, Replay, logger, passThrough, passToLocalhost, passWhenBloodyOrCheat, recorder, replay,
...
passWhenBloodyOrCheat = function(request) {
  return replay.isAllowed(request.url.hostname) || replay.isIgnored(request.url.hostname) || (replay.mode === "cheat" && !replay.isIgnored(request.url.hostname));
};
